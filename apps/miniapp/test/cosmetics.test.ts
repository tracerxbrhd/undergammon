...
import { resolveCheckerSet, resolveDiceSkin, resolveMatchCosmetics } from '../src/game/cosmetics';
...
describe('resolveMatchCosmetics', () => {
  ...
  it('keeps player-owned checker and dice cosmetics aligned when perspective changes', () => {
    const players = {
      A: {
        cosmetics: {
  ...
  it('maps checker and dice cosmetics through application-controlled presentation classes', () => {
